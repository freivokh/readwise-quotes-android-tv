  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `quotes` (`id` INTEGER NOT NULL, `text` TEXT NOT NULL, `title` TEXT, `author` TEXT, `bookCover` TEXT, `tags` TEXT NOT NULL, `isFavorite` INTEGER NOT NULL, `updatedAt` TEXT NOT NULL, `sourceType` TEXT, `bookId` INTEGER, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '4ad352e12da6a2e2aef9f1c77cf6cc86')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsQuotes.put("title", new TableInfo.Column("title", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsQuotes.put("author", new TableInfo.Column("author", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsQuotes.put("bookCover", new TableInfo.Column("bookCover", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsQuotes.put("updatedAt", new TableInfo.Column("updatedAt", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsQuotes.put("sourceType", new TableInfo.Column("sourceType", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsQuotes.put("bookId", new TableInfo.Column("bookId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoQuotes.equals(_existingQuotes)) {
          return new RoomOpenHelper.ValidationResult(false, "quotes(com.readwisequotes.data.model.Quote).\n"
                  + " Expected:\n" + _infoQuotes + "\n"
                  + " Found:\n" + _existingQuotes);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "4ad352e12da6a2e2aef9f1c77cf6cc86", "b75fbfc4b97bd6edea93e11fd49b4a0f");
